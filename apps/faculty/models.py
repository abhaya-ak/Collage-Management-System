...
from apps.core.enums import FacultyStatus, LeaveStatus
...
# =============================================================
# FacultyLeave — teacher leave with admin approval workflow
# =============================================================
class FacultyLeave(BaseModel, SoftDeleteMixin):
    faculty = models.ForeignKey(
        Faculty, on_delete=models.CASCADE, related_name="leaves"
    )
    ...
    def __str__(self):
        return f"{self.faculty.employee_id} {self.start_date}–{self.end_date} [{self.status}]"
